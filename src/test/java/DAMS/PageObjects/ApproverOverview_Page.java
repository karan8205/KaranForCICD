...
//	private WebElement Authorization_dropdown;
	...
	@FindBy(xpath = "//button[@id=\"Approval Status\"]")
...
//		click(reject);
	...
	public void filter_search(String status) throws Throwable {
		try {
			...
			clickJS(Approver_Overview_approval_status_filter);
			...
			Scrollright_waitForWebElementToAppear(Approver_Overview_apply_filter);
