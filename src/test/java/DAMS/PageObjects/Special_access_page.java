...
public class Special_access_page extends AbstractComponents {
	...
	private WebElement View_Publisher_Onboarding_submit;
	...
	public String functional_role(String name) throws Throwable {
		Thread.sleep(2000);
	...
	public void Third_Party_Publisher() throws InterruptedException {
		...
		Thread.sleep(1000);
		click(Third_Party_Publisher);
		Thread.sleep(3000);
		scrollDown(Third_Party_Publisher_new_request);
