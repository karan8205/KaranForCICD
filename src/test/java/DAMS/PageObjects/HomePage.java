...
public class HomePage extends AbstractComponents {
	...
	@FindBy(xpath = "//span[text()='Click here to apply for functional roles']//..//parent::button")
...
//	private WebElement please_select_your_user_type;
	...
	public void click_here_to_apply_for_functional_roles_click() throws InterruptedException {
		if(!click_here_to_apply_for_Functional_roles.getAttribute("class").contains("disabled")) {
		waitForWebElementToAppear(click_here_to_apply_for_Functional_roles);
		waitForWebElementToAppear(click_here_to_apply_for_Functional_roles);
		waitForWebElementToAppear(click_here_to_apply_for_Functional_roles);
		waitForelementToBeClickable(click_here_to_apply_for_Functional_roles);
		clickJS(click_here_to_apply_for_Functional_roles);
	}
		else {
			dropBtn();
		}
