...
public class NewPermission_Request_Page extends AbstractComponents {
	...
	public boolean raise_Diagnostic_Authority_Request(HashMap<String, String> input, Object object, String user_role,
		...
		// || value_selected.contains("ECU Supplier - Warranty
		// Return")||value_selected.contains("Vehicle Validation")) {
	...
	public List<Object> raise_Enhance_Right_Request_External(HashMap<String, String> input)
			throws InterruptedException {
		EnhanceRight__Authority_display();
	...
	public List<Object> raise_Enhance_Right_Request_Supplier(HashMap<String, String> input)
			throws InterruptedException {
		EnhanceRight__Authority_display();
		Thread.sleep(2000);
	...
	public List<Object> raise_Enhance_Right_Request_ServicePrincipal(HashMap<String, String> input)
			throws InterruptedException {
		Thread.sleep(2000);
	...
	public boolean raise_nestT_Request_Multiple(Map<String, String> input) throws InterruptedException {
		// SpecialCase_display();
		Thread.sleep(2000);
		// hari
	...
	public boolean raise_FOTA_Request_xOTA(String SpecialCaseFOTA, String DiagPermission, String ECU_Qualifier_FOTA,
			String Reason_for_FOTA, String value_selected, String ServiceID, String PermissionValidity,
			String EnhanceValidity) throws InterruptedException {
	...
	public boolean Diagnostic_Authority_ECU_Visible_or_not_for_pending_Approved(HashMap<String, String> input,
		...
		if (value_selected.contains("ECU Supplier - Key Management")
				|| value_selected.contains("ECU Supplier – Development")
				|| value_selected.contains("ECU Supplier - Warranty Return")
				|| value_selected.contains("Vehicle Validation")) {
			select_functional_role(value_selected);
		}
	...
	public boolean replacement_package_ECU_Visible_or_not_for_pending_approved_rejected(HashMap<String, String> input,
			String Special_Case, String Orgin_COT, String Reason_for_RP, String Target_COT, String ECU_Qualifier_for_RP,
			String BackendRoot_COT, String BackendOrigin_COT, String BackendTarget_COT)
			throws InterruptedException, Throwable {
		SpecialCase_display();
	...
	public boolean Diagnostic_Authority_ECU_Visible_or_not_for_pending_Approved(HashMap<String, String> input)
		...
		for (int i = 0; i < ur.length; i++) {
			...
			logger.info(user_role);
			if (user_role.equalsIgnoreCase("Development ENHANCED") || (user_role.equalsIgnoreCase("Production"))
					|| (user_role.equalsIgnoreCase("After-Sales ENHANCED"))
					|| user_role.equalsIgnoreCase("Development - ATG")) {
				Thread.sleep(2000);
				String userrole = select_user_role(user_role);
				test.info("User role is Selected:  " + userrole);
				String ecu_Restriction_visible_or_not = ECU_Restriction_visible_or_not(ECU_Restriction);
