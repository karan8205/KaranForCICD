...
public class TC80_ADD_UpdateFR_ECU_Rejected extends BaseClass {
	public static PropertyFile prop = new PropertyFile();

	@Test(dataProvider = "getData1", priority = 0)
	public static void add_functional_role_SpecialAccess_Reject(HashMap<String, String> input) throws Throwable {
