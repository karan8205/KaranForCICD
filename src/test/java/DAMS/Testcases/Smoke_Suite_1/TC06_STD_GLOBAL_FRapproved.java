...
public class TC06_STD_GLOBAL_FRapproved extends BaseClass {
...
//		driver.close();
	...
	public static void Functional_role_request_approved_Supplier(HashMap<String, String> input) throws Throwable {
		test.log(Status.INFO, "<span style=\"color: blue;\"><b><i><u>"
