...
public class TC83_REMOVE_UpdateFR_ECU_Rejected extends BaseClass {
	public static PropertyFile prop = new PropertyFile();

	@Test(dataProvider = "getData1", priority = 0)
	public static void remove_functional_role_SpecialAccess_Reject(HashMap<String, String> input) throws Throwable {
		...
		special.add_functional_role(input.get("Functional_role"), input.get("Business_unit"),
		...
		approver_overview.Reject_Request_Approval("Update Functional Role",ecu_Qualifier_Update_for_Functional_Role_Overview.get(5));
