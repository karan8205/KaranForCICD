...
public class TC68_xOTA_FOTA_Pending extends BaseClass {

	@Test(dataProvider = "getData_Service", priority = 0)
	public static void create_FOTA_Request_ServicePrincipal_Pending(HashMap<String, String> input) throws Throwable {
