...
public class TC46_NestT_SeriesCOT_ATG_Approved extends BaseClass {
	...
	public static void create_and_Approve_NestT__Request_External_test_case(HashMap<String, String> input) throws Throwable {
