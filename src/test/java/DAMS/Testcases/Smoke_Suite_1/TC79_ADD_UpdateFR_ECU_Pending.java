...
public class TC79_ADD_UpdateFR_ECU_Pending extends BaseClass {
	public static PropertyFile prop = new PropertyFile();

	@Test(dataProvider = "getData1", priority = 0)
	public static void add_functional_role_SpecialAccess_Pending(HashMap<String, String> input) throws Throwable {
