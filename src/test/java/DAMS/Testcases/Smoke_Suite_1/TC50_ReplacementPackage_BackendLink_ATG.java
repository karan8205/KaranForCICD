...
public class TC50_ReplacementPackage_BackendLink_ATG extends BaseClass {
	...
	public static void create_replacement_package_Internal(HashMap<String, String> input) throws Throwable {
		...
		create_replacement_package_request(input.get("Functional_role_internal"),input.get("SpecialCase"), input.get("Reason_for_RP"),
	...
	public static void create_replacemnet_package_External(HashMap<String, String> input) throws Throwable {
		...
		create_replacement_package_request(input.get("Functional_role_External"),input.get("SpecialCase"), 
				input.get("Reason_for_RP"),input.get("ECU_Qualifier_for_RP"),input.get("BackendRoot_COT"),
	...
	public static void create_replacemnet_package_Supplier(HashMap<String, String> input) throws Throwable {
		...
		List<String >create_replacement_package_request = create_replacement_package_request(input.get("Functional_role_supplier"),input.get("SpecialCase"),
				input.get("Reason_for_supplier_FR"),input.get("ECU_Supplier"),input.get("BackendRoot_COT"),
				input.get("BackendOrigin_COT"),input.get("BackendTarget_COT"));
		test.pass("User is able to create Replacement package request when the status is pending");
		logger.info("User is able to create Replacement package request when the status is pending");
		softAssertionALL();
	...
	public static List<String> create_replacement_package_request(String functionalrole,String SpecialCase, String Reason_for_RP, String ECU_Qualifier_for_RP,String BackendRoot_COT,String BackendOrigin_COT,String BackendTarget_COT) throws Throwable {
