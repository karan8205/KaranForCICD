...
public class PropertyFile extends BaseClass {
    ...
    public String getcleanupUrl() {
        String cleanup_url = pro.getProperty("cleanup_url_" + environment);
        if (cleanup_url == null) {
            cleanup_url = pro.getProperty("cleanup_url_STG");
        }
        return cleanup_url;
    }
    ...
    public String getsecurity_key_MFA_Internal() {
        String key = pro.getProperty("security_key_MFA_Internal");
        return key;
    }

    public String getsecurity_key_MFA_External() {
        String key = pro.getProperty("security_key_MFA_External");
        return key;
    }

    public String getsecurity_key_MFA_Supplier() {
