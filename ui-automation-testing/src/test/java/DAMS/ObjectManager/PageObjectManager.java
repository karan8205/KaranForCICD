...
public class PageObjectManager extends AbstractComponents {
	...
	public LoginPage getLoginPage() {
		...
		return (loginPage == null) ? loginPage = new LoginPage(BaseClass.getDriver()) : loginPage;

	}

	public HomePage getHomePage() {

		return (homePage == null) ? homePage = new HomePage(BaseClass.getDriver()) : homePage;

	}

	public GTC_Page getGtcPage() {

		return (gtcPage == null) ? gtcPage = new GTC_Page(BaseClass.getDriver()) : gtcPage;
	...
	public New_Functional_Role_Request_Page getNewFunctionalRoleRequestPage() {
		...
		return (newFunctionalRoleRequest == null)
				? newFunctionalRoleRequest = new New_Functional_Role_Request_Page(BaseClass.getDriver())
	...
	public Functional_role_page getfunctional_role_page() {
		...
		return (functional_role_page == null) ? functional_role_page = new Functional_role_page(BaseClass.getDriver())
	...
	public ApproverOverview_Page getapproverOverview_page() {
		...
		return (approverOverview == null) ? approverOverview = new ApproverOverview_Page(BaseClass.getDriver()) : approverOverview;

	}

	public MyRequest_Page getmyRequest_Page() {

		return (myRequest == null) ? myRequest = new MyRequest_Page(BaseClass.getDriver()) : myRequest;

	}

	public NewPermission_Request_Page getNewPermission_Request_Page() {

		return (newPermission_Request == null) ? newPermission_Request = new NewPermission_Request_Page(BaseClass.getDriver())
	...
	public Request_overview_page getRequest_overview_page() {
		...
		return (request_overview == null) ? request_overview = new Request_overview_page(BaseClass.getDriver()) : request_overview;

	}

	public Onboard_new_ECU_page getonboard_new_ECU_page() {

		return (onboard_new_ECU == null) ? onboard_new_ECU = new Onboard_new_ECU_page(BaseClass.getDriver()) : onboard_new_ECU;

	}

	public MyDeputy_Page getMyDeputy_page() {

		return (myDeputy_page == null) ? myDeputy_page = new MyDeputy_Page(BaseClass.getDriver()) : myDeputy_page;

	}

	public Special_access_page getSpecial_access_page() {

		return (special_access_page == null) ? special_access_page = new Special_access_page(BaseClass.getDriver())
				: special_access_page;
	...
	public ReadView_Permission getReadView_Permission_Page() {
		...
		return (read == null) ? read = new ReadView_Permission(BaseClass.getDriver())
				: read;
	}
