...
public class TC54_ReplacementPackage_RootBackend_Swap_ATG_Rejected extends BaseClass {

	@Test(dataProvider = "getData_Internal", priority = 0)
	public static void replacementPackage_ATG_RootBackend_Internal_Rejected(HashMap<String, String> input) throws Throwable {
	...
	public static void replacementPackage_ATG_RootBackend_External_Rejected(HashMap<String, String> input) throws Throwable {
		test.log(Status.INFO, "<span style=\"color: blue;\"><b><i><u>"
	...
	public static void replacementPackage_ATG_RootBackend_Supplier_Rejected(HashMap<String, String> input) throws Throwable {
		test.log(Status.INFO, "<span style=\"color: blue;\"><b><i><u>"
