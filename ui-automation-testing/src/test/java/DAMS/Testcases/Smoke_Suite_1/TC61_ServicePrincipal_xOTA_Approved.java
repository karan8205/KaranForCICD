...
public class TC61_ServicePrincipal_xOTA_Approved extends BaseClass{
	
	@Test(dataProvider = "getData_Service", priority = 0)
	public static void servicePrincipal_STD_XOTA_Approved(HashMap<String, String> input) throws Throwable {
