...
public class TC96_ECU_Certificate_Request_Rejected extends BaseClass {
	public static PropertyFile prop = new PropertyFile();

	@Test(dataProvider = "getData1", priority = 1)
	public static void ecu_Certificate_Request_rejected(HashMap<String, String> input) throws Throwable {
		test.log(Status.INFO, "<span style=\"color: blue;\"><b><i><u>"
				+ "ECU Certificate Request Rejected"
				+ "</u></i></b>");
        ...
        approver_overview.Reject_Request_Approval("ECU Certificate Request",id);
