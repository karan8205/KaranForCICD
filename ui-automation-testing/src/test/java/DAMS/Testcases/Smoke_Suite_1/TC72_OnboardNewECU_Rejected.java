...
public class TC72_OnboardNewECU_Rejected extends BaseClass {

	@Test(dataProvider = "getData_Internal", priority = 0)
	public static void OnboardNewEcu_Rejected(HashMap<String, String> input)
			throws Throwable {
		...
		approver_overview.Reject_Request_Approval("Onboard New ECU", id);
