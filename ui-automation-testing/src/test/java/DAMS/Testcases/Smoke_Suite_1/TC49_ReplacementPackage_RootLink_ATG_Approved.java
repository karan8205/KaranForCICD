...
public class TC49_ReplacementPackage_RootLink_ATG_Approved extends BaseClass {

	@Test(dataProvider = "getData_Internal", priority = 0, enabled = false)
	public static void create_and_reject_Replacement_Request_Internal_test_case(HashMap<String, String> input)
			throws Throwable {
	...
	public static void create_replacemnet_package_Supplier(HashMap<String, String> input) throws Throwable {
		...
		List<String> create_replacement_package_request = TC47_ReplacementPackage_RootLink_ATG
				.create_replacement_package_request_Supplier(
	...
	public static List<String> create_replacement_package_request_External(HashMap<String, String> input)
			throws Throwable {
		test.info("Replacement package request");
		logger.info("Replacement package request");
		myreq.select_NewPermission_request();
	...
	public static void approve_special_cases_Replacement_request(HashMap<String, String> input,
		...
		String Replacement_approval_status_after_level1_approval = approver_overview
				.approve_replacement_Package_Request(prop.get_user_type_Internal(), prop.getStatus_pending(),
						input.get("SpecialCase"), create_special_cases_Replacement_request);
		...
		logger.info(
				"User is able to view navigate to request role overview page and check if the status is pending after 1st level approval");
		String Replacement_approval_status_after_level2_approval = approver_overview
				.approve_replacement_Package_Request(prop.get_user_type_Internal(), prop.getStatus_pending(),
						input.get("SpecialCase"), create_special_cases_Replacement_request);
