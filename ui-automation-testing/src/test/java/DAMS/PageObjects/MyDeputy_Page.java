...
public class MyDeputy_Page extends AbstractComponents {
	...
	public void Validate_Mydeputy(String name) throws Throwable {
		...
		Thread.sleep(500);
		BaseClass.getDriver().findElement(By.xpath("//span[text()='" + name + "']")).click();
		Thread.sleep(100);
		waitForWebElementToAppear(Add_button);
		click(Add_button);
	}

	// public void myDeputy_list(String deputy_txt, String email_txt, String
	// username_txt) throws InterruptedException {
	// Thread.sleep(2000);
